...
We also have a [parallel-claudes skill](/toolbox/skills#parallel-claudes) that teaches Claude Code how to orchestrate multiple parallel sessions using `cw` automatically — splitting tasks, launching subagents, monitoring progress, and merging results. Install it with:
